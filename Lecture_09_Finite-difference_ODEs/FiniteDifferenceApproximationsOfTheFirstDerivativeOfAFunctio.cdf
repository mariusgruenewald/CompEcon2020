...
NotebookDataLength[     90254,       1875]
NotebookOptionsPosition[     63078,       1280]
NotebookOutlinePosition[     89380,       1842]
CellTagsIndexPosition[     89269,       1836]
WindowTitle->Finite Difference Approximations of the First Derivative of a \
Function
WindowFrame->Normal*)
...
Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`bdd$$ = False, $CellContext`cdd$$ = 
    False, $CellContext`dx$$ = 1, $CellContext`f$$ = 
    E^$CellContext`x, $CellContext`fdd$$ = False, $CellContext`x0$$ = 0, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`f$$], E^$CellContext`x, "f(x)"}, {
      E^$CellContext`x -> "\!\(\*SuperscriptBox[\(e\), \(x\)]\)", 
       Sin[$CellContext`x] -> "sin(x)", $CellContext`x^3 -> 
       "\!\(\*SuperscriptBox[\(x\), \(3\)]\)"}}, {
      Hold[""], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`fdd$$], False, "forward"}, {True, False}}, {{
       Hold[$CellContext`cdd$$], False, "central"}, {True, False}}, {{
       Hold[$CellContext`bdd$$], False, "backward"}, {True, False}}, {
      Hold[
       Row[{
         Style["divided differences: ", Bold], 
         Spacer[20], 
         Manipulate`Place[1], 
         Spacer[20], 
         Manipulate`Place[2], 
       ...
       Style["x value"]}, -2, 2}, {{
       Hold[$CellContext`dx$$], 1, 
       Style["h"]}, 0.1, 1}}, Typeset`size$$ = {461., {179.84375, 185.15625}},
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`f$63985$$ = False, $CellContext`fdd$63986$$ = 
    False, $CellContext`cdd$63987$$ = False, $CellContext`bdd$63988$$ = 
    False, $CellContext`x0$63989$$ = 0, $CellContext`dx$63990$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`bdd$$ = False, $CellContext`cdd$$ = 
        False, $CellContext`dx$$ = 1, $CellContext`f$$ = 
        E^$CellContext`x, $CellContext`fdd$$ = False, $CellContext`x0$$ = 0}, 
      "ControllerVariables" :> {
        Hold[$CellContext`f$$, $CellContext`f$63985$$, False], 
        Hold[$CellContext`fdd$$, $CellContext`fdd$63986$$, False], 
        Hold[$CellContext`cdd$$, $CellContext`cdd$63987$$, False], 
        Hold[$CellContext`bdd$$, $CellContext`bdd$63988$$, False], 
        Hold[$CellContext`x0$$, $CellContext`x0$63989$$, 0], 
        Hold[$CellContext`dx$$, $CellContext`dx$63990$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`xa$, $CellContext`xb$, $CellContext`y0$, \
$CellContext`ya$, $CellContext`yb$, $CellContext`tanslope$, \
$CellContext`fddslope$, $CellContext`cddslope$, $CellContext`bddslope$, \
$CellContext`tanline$, $CellContext`fddline$, $CellContext`cddline$, \
$CellContext`bddline$, $CellContext`xmin$, $CellContext`xmax$, \
$CellContext`plot1$, $CellContext`plot2$, $CellContext`plot3$, \
$CellContext`plot4$, $CellContext`plot5$, $CellContext`plot6$}, \
$CellContext`xa$ = $CellContext`x0$$ - $CellContext`dx$$; $CellContext`xb$ = \
$CellContext`x0$$ + $CellContext`dx$$; $CellContext`y0$ = 
         ReplaceAll[$CellContext`f$$, $CellContext`x -> $CellContext`x0$$]; \
$CellContext`ya$ = 
         ReplaceAll[$CellContext`f$$, $CellContext`x -> $CellContext`xa$]; \
$CellContext`yb$ = 
         ReplaceAll[$CellContext`f$$, $CellContext`x -> $CellContext`xb$]; \
$CellContext`tanslope$ = ReplaceAll[
           
           Dt[$CellContext`f$$, $CellContext`x], $CellContext`x -> \
$CellContext`x0$$]; $CellContext`fddslope$ = ($CellContext`yb$ - \
$CellContext`y0$)/($CellContext`xb$ - $CellContext`x0$$); \
$CellContext`cddslope$ = ($CellContext`yb$ - \
$CellContext`ya$)/($CellContext`xb$ - $CellContext`xa$); \
$CellContext`bddslope$ = ($CellContext`y0$ - \
$CellContext`ya$)/($CellContext`x0$$ - $CellContext`xa$); \
$CellContext`tanline$ = $CellContext`tanslope$ ($CellContext`x - \
$CellContext`x0$$) + $CellContext`y0$; $CellContext`fddline$ = \
$CellContext`fddslope$ ($CellContext`x - $CellContext`xb$) + $CellContext`yb$; \
$CellContext`cddline$ = $CellContext`cddslope$ ($CellContext`x - \
$CellContext`xb$) + $CellContext`yb$; $CellContext`bddline$ = \
$CellContext`bddslope$ ($CellContext`x - $CellContext`xa$) + $CellContext`ya$; 
        Which[$CellContext`xa$ >= 
          0, {$CellContext`xmin$ = 
           0, $CellContext`xmax$ = $CellContext`xb$}, $CellContext`xb$ <= 
          0, {$CellContext`xmin$ = $CellContext`xa$, $CellContext`xmax$ = 0}, 
          
          And[$CellContext`xa$ < 0, $CellContext`xb$ > 
           0], {$CellContext`xmin$ = $CellContext`xa$, $CellContext`xmax$ = \
$CellContext`xb$}]; 
        If[$CellContext`fdd$$ == True, $CellContext`plot1$ = 
          Plot[$CellContext`fddline$, {$CellContext`x, $CellContext`x0$$, \
$CellContext`xb$}, 
            PlotStyle -> {Thickness -> 0.002, Green}], $CellContext`plot1$ = 
          Plot[$CellContext`f$$, {$CellContext`x, $CellContext`xmin$, \
$CellContext`xmax$}]]; 
        If[$CellContext`cdd$$ == True, $CellContext`plot2$ = 
          Plot[$CellContext`cddline$, {$CellContext`x, $CellContext`xa$, \
$CellContext`xb$}, 
            PlotStyle -> {Thickness -> 0.002, Red}], $CellContext`plot2$ = 
          Plot[$CellContext`f$$, {$CellContext`x, $CellContext`xmin$, \
$CellContext`xmax$}]]; 
        If[$CellContext`bdd$$ == True, $CellContext`plot3$ = 
          Plot[$CellContext`bddline$, {$CellContext`x, $CellContext`xa$, \
$CellContext`x0$$}, 
            PlotStyle -> {Thickness -> 0.002, Blue}], $CellContext`plot3$ = 
          Plot[$CellContext`f$$, {$CellContext`x, $CellContext`xmin$, \
$CellContext`xmax$}]]; If[
          
          Or[$CellContext`fdd$$ == True, $CellContext`cdd$$ == 
           True], $CellContext`plot4$ = 
          ListPlot[{{$CellContext`xb$, $CellContext`yb$}}, PlotStyle -> {
              PointSize[Large], Red}, Filling -> Axis], $CellContext`plot4$ = 
          ListPlot[{{$CellContext`x0$$, $CellContext`y0$}}, PlotStyle -> {
              PointSize[Large], Black}]]; If[
          
          Or[$CellContext`bdd$$ == True, $CellContext`cdd$$ == 
           True], $CellContext`plot5$ = 
          ListPlot[{{$CellContext`xa$, $CellContext`ya$}}, PlotStyle -> {
              PointSize[Large], Red}, Filling -> Axis], $CellContext`plot5$ = 
          ListPlot[{{$CellContext`x0$$, $CellContext`y0$}}, PlotStyle -> {
              PointSize[Large], Black}]]; $CellContext`plot6$ = 
         ListPlot[{{$CellContext`x0$$, $CellContext`y0$}}, PlotStyle -> {
             PointSize[Large], Black}, Filling -> Axis]; Column[{
           Show[
            
            Plot[{$CellContext`f$$, $CellContext`tanline$}, {$CellContext`x, \
$CellContext`xmin$, $CellContext`xmax$}, ImageSize -> {450, 200}, PlotRange -> 
             Full, PlotStyle -> {{Thickness -> 0.008, Black}, {
               Thickness -> 0.002, Orange}}, Background -> LightYellow, 
             AxesOrigin -> {0, 0}, ImageSize -> 
             1.1 {400, 
               300}], $CellContext`plot1$, $CellContext`plot2$, \
$CellContext`plot3$, $CellContext`plot4$, $CellContext`plot5$, \
$CellContext`plot6$], 
           Text[
            Style[
             ...
             Grid[{{"\nMethod", "     ", "\nApproximation", "     ", 
               ...
               "forward divided difference", "     ", 
                PaddedForm[
                 N[$CellContext`fddslope$, 20], {4, 4}], "     ", 
                PaddedForm[
                 N[
                  Abs[$CellContext`tanslope$ - $CellContext`fddslope$], 20], {
                 4, 4}]}, {"central divided difference", "     ", 
                PaddedForm[
                 N[$CellContext`cddslope$, 20], {4, 4}], "     ", 
                PaddedForm[
                 N[
                  Abs[$CellContext`tanslope$ - $CellContext`cddslope$], 20], {
                 4, 4}]}, {"backward divided difference", "     ", 
                PaddedForm[
                 N[$CellContext`bddslope$, 20], {4, 4}], "     ", 
                PaddedForm[
                 N[
                  Abs[$CellContext`tanslope$ - $CellContext`bddslope$], 20], {
                 4, 4}]}, {"", "     ", "", "     ", ""}, {
               "exact value", "     ", 
                PaddedForm[
                 N[$CellContext`tanslope$, 20], {4, 4}], "     ", ""}}, 
              Alignment -> Center, ItemSize -> Full], 14]]}, Dividers -> All, 
          Alignment -> Center]], 
      "Specifications" :> {{{$CellContext`f$$, E^$CellContext`x, "f(x)"}, {
         E^$CellContext`x -> "\!\(\*SuperscriptBox[\(e\), \(x\)]\)", 
          Sin[$CellContext`x] -> "sin(x)", $CellContext`x^3 -> 
          "\!\(\*SuperscriptBox[\(x\), \(3\)]\)"}}, 
        "", {{$CellContext`fdd$$, False, "forward"}, {True, False}, 
         ControlPlacement -> 1}, {{$CellContext`cdd$$, False, "central"}, {
         True, False}, ControlPlacement -> 
         2}, {{$CellContext`bdd$$, False, "backward"}, {True, False}, 
         ControlPlacement -> 3}, 
        Row[{
          Style["divided differences: ", Bold], 
          Spacer[20], 
          ...
          Manipulate`Place[2], 
          Spacer[20], 
          Manipulate`Place[3]}], {{$CellContext`x0$$, 0, 
          Style["x value"]}, -2, 2, Appearance -> 
         "Labeled"}, {{$CellContext`dx$$, 1, 
          Style["h"]}, 0.1, 1, Appearance -> "Labeled"}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{506., {264., 269.}},
...
Cell["\<\
Derivatives of functions can be approximated by finite difference formulas. \
In this Demonstration, we compare the various difference approximations with \
the exact value.\
\>", "ManipulateCaption",
 CellID->18539184],
...
Cell["\<\
The simplest finite difference formulas for the first derivative of a \
function are:\
\>", "DetailNotes",
 CellID->699943270],
   ...
   RowBox[{
    ...
    FractionBox[
     RowBox[{
      RowBox[{"f", "(", 
       RowBox[{"x", "+", "h"}], ")"}], "-", 
      RowBox[{"f", "(", "x", ")"}]}], "h"]}], TraditionalForm]], "InlineMath"],
 "\t\t(forward difference)\n",
 Cell[BoxData[
  FormBox[
   RowBox[{
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"O", "(", "h", ")"}], TraditionalForm]], "InlineMath"],
...
Cell["\<\
In this Demonstration, we show the difference in values calculated from the \
three difference formulas and the exact value.\
\>", "DetailNotes",
 CellID->509498594],

Cell[TextData[{
 "Questions:\n1. Does the true error increase proportionally with the step \
size, ",
 Cell[BoxData[
  FormBox["h", TraditionalForm]], "InlineMath"],
 ", for the forward and backward difference formulas?\n2. Does the true error \
increase ",
 "proportionally ",
 "with the square of the step size, ",
 Cell[BoxData[
  FormBox["h", TraditionalForm]], "InlineMath"],
...
Cell[TextData[{
 "[1] A. A. Kaw, D. Nguyen, and E. E. Kalu, ",
 StyleBox["Numerical Methods with Applications.",
  FontSlant->"Italic"],
 " ",
 ButtonBox["http://numericalmethods.eng.usf.edu/publications_book.html",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://numericalmethods.eng.usf.edu/publications_book.html"], None},
  ButtonNote->"http://numericalmethods.eng.usf.edu/publications_book.html"],
 ". "
}], "DetailNotes",
 CellID->378856485],
...
Cell[TextData[{
 ButtonBox["The Definition of the Derivative",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/TheDefinitionOfTheDerivative/"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/TheDefinitionOfTheDerivative/"],
 " (",
...
Cell[TextData[{
 ButtonBox["Finite Difference",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/FiniteDifference.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/FiniteDifference.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Backward Difference",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/BackwardDifference.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/BackwardDifference.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Forward Difference",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/ForwardDifference.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/ForwardDifference.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
FiniteDifferenceApproximationsOfTheFirstDerivativeOfAFunctio&version=0004"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
FiniteDifferenceApproximationsOfTheFirstDerivativeOfAFunctio/\
FiniteDifferenceApproximationsOfTheFirstDerivativeOfAFunctio-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Finite Difference Approximations of the First Derivative of a \
Function",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
FiniteDifferenceApproximationsOfTheFirstDerivativeOfAFunctio/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
FiniteDifferenceApproximationsOfTheFirstDerivativeOfAFunctio/"],
 "\"",
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Vincent Shatlock",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Vincent+\
Shatlock"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Vincent+Shatlock"],
 " and ",
 ButtonBox["Autar Kaw",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Autar+Kaw"], 
    None},
  ButtonNote->"http://demonstrations.wolfram.com/author.html?author=Autar+Kaw"]
}], "Author",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[46094, 807, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[46355, 816, 3221, 69, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[62256, 1255, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 88982, 1825},
 {"Copyright", 89177, 1830}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1321, 32, 34328, 567, 70, "DemonstrationHeader"],
Cell[35652, 601, 99, 2, 70, "DemoTitle"],
Cell[35754, 605, 10105, 193, 70, "Output",
 CellID->2048281234],
Cell[45862, 800, 229, 5, 70, "ManipulateCaption",
 CellID->18539184],
Cell[46094, 807, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[46355, 816, 3221, 69, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[49579, 887, 33, 0, 70, "DetailsSection"],
Cell[49615, 889, 205, 7, 70, "DetailNotes",
 CellID->248601808],
Cell[49823, 898, 473, 19, 70, "DetailNotes",
 CellID->79799879],
Cell[50299, 919, 136, 4, 70, "DetailNotes",
 CellID->699943270],
Cell[50438, 925, 1121, 41, 70, "DetailNotes",
 CellID->228148261],
Cell[51562, 968, 386, 12, 70, "DetailNotes",
 CellID->23699084],
Cell[51951, 982, 175, 4, 70, "DetailNotes",
 CellID->509498594],
Cell[52129, 988, 460, 13, 70, "DetailNotes",
 CellID->351394288],
Cell[52592, 1003, 52, 1, 70, "DetailNotes",
 CellID->481259174],
Cell[52647, 1006, 457, 12, 70, "DetailNotes",
 CellID->378856485],
Cell[53107, 1020, 44, 0, 70, "RelatedLinksSection"],
Cell[53154, 1022, 523, 16, 70, "RelatedLinks",
 CellID->255616111],
Cell[53680, 1040, 641, 21, 70, "RelatedLinks",
 CellID->318693952],
Cell[54324, 1063, 647, 21, 70, "RelatedLinks",
 CellID->257969892],
Cell[54974, 1086, 644, 21, 70, "RelatedLinks",
 CellID->718646301],
Cell[55621, 1109, 4928, 92, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[60552, 1203, 45, 0, 70, "CitationSection"],
Cell[60600, 1205, 1053, 28, 70, "Citations"],
Cell[61656, 1235, 597, 18, 70, "Author",
 CellID->158222411],
Cell[62256, 1255, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature FSqWWwfI9KYn0v7YMRWw9xMx *)
