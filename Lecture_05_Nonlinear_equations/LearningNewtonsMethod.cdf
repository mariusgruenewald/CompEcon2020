...
NotebookDataLength[     78103,       1551]
NotebookOptionsPosition[     51187,        974]
NotebookOutlinePosition[     77437,       1535]
CellTagsIndexPosition[     77326,       1529]
WindowTitle->Learning Newton's Method
WindowFrame->Normal*)
...
Cell["Learning Newton's Method", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`d$$ = $CellContext`f21, $CellContext`n$$ = 
    1, $CellContext`x0$$ = 0.6, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`d$$], $CellContext`f21, 
       "function"}, {$CellContext`f1 -> 
       TraditionalForm[-2 + $CellContext`x^2], $CellContext`f21 -> 
       TraditionalForm[
         Cos[$CellContext`x]], $CellContext`f3 -> 
       TraditionalForm[-7 + $CellContext`x^3], $CellContext`f5 -> 
       TraditionalForm[-1 + $CellContext`x - 
         3 $CellContext`x^2 + $CellContext`x^3]}}, {{
       Hold[$CellContext`n$$], 1, "n"}, {0, 1, 2, 3, 4, 5, 6}}, {{
       Hold[$CellContext`x0$$], 0.6, 
       Subscript["x", "0"]}, 0.01, 6.11}}, Typeset`size$$ = {
    600., {171.5, 176.5}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`d$30969$$ = 
    False, $CellContext`n$30970$$ = 0, $CellContext`x0$30971$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`d$$ = $CellContext`f21, $CellContext`n$$ = 
        1, $CellContext`x0$$ = 0.6}, "ControllerVariables" :> {
        Hold[$CellContext`d$$, $CellContext`d$30969$$, False], 
        Hold[$CellContext`n$$, $CellContext`n$30970$$, 0], 
        Hold[$CellContext`x0$$, $CellContext`x0$30971$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, 
      "Body" :> $CellContext`newton[$CellContext`d$$, 
        N[$CellContext`x0$$], 0, 2 Pi, $CellContext`n$$], 
      "Specifications" :> {{{$CellContext`d$$, $CellContext`f21, 
          "function"}, {$CellContext`f1 -> 
          TraditionalForm[-2 + $CellContext`x^2], $CellContext`f21 -> 
          TraditionalForm[
            Cos[$CellContext`x]], $CellContext`f3 -> 
          TraditionalForm[-7 + $CellContext`x^3], $CellContext`f5 -> 
          TraditionalForm[-1 + $CellContext`x - 
            3 $CellContext`x^2 + $CellContext`x^3]}, ControlType -> 
         PopupMenu}, {{$CellContext`n$$, 1, "n"}, {0, 1, 2, 3, 4, 5, 6}, 
         ControlType -> SetterBar}, {{$CellContext`x0$$, 0.6, 
          Subscript["x", "0"]}, 0.01, 6.11, Appearance -> "Labeled"}}, 
      "Options" :> {}, "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{645., {241., 246.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`newton[
        ...
        Module[{$CellContext`list = 
           NestList[# - $CellContext`f[#]/Derivative[
             1][$CellContext`f][#]& , $CellContext`x0, $CellContext`n]}, 
          Column[{
            TraditionalForm[
             Text[
              Style[
...
$CellContext`k = 0]^$CellContext`n], " = ", $CellContext`list}], 14]]], 
            Plot[
             $CellContext`f[$CellContext`x], {$CellContext`x, $CellContext`a, \
$CellContext`b}, PlotRange -> All, AxesLabel -> {
               Style[$CellContext`x, 16], 
               Style[$CellContext`y, 16]}, PlotStyle -> Thickness[0.006], 
             Epilog -> {{Red, 
                Thickness[0.002], 
                Arrowheads[0.03], 
                Arrow[
                 Most[
                  Flatten[
                   Map[{{#, 0}, {#, 
                    $CellContext`f[#]}}& , $CellContext`list], 1]]]}, {
                PointSize[0.015], 
                Point[{$CellContext`x0, 0}]}}, ImageSize -> {600, 325}]}, 
           Center]], Attributes[Derivative] = {NHoldAll, ReadProtected}, 
        Attributes[Subscript] = {NHoldRest}, 
        Subscript[$CellContext`w, $CellContext`opt] = {2.706, 3.686}, 
        Attributes[PlotRange] = {ReadProtected}, $CellContext`f21[
          Pattern[$CellContext`x, 
           Blank[]]] := Cos[$CellContext`x], $CellContext`f1[
          Pattern[$CellContext`x, 
           Blank[]]] := $CellContext`x^2 - 2, $CellContext`f3[
          Pattern[$CellContext`x, 
           Blank[]]] := $CellContext`x^3 - 7, $CellContext`f5[
          Pattern[$CellContext`x, 
           Blank[]]] := $CellContext`x^3 - 
         3 $CellContext`x^2 + $CellContext`x - 1}; Typeset`initDone$$ = True); 
     ReleaseHold[
       HoldComplete[{$CellContext`f1[
           Pattern[$CellContext`x, 
            Blank[]]] := $CellContext`x^2 - 2, $CellContext`f21[
           Pattern[$CellContext`x, 
            Blank[]]] := Cos[$CellContext`x], $CellContext`f3[
           Pattern[$CellContext`x, 
            Blank[]]] := $CellContext`x^3 - 7, $CellContext`f5[
           Pattern[$CellContext`x, 
            Blank[]]] := $CellContext`x^3 - 
          3 $CellContext`x^2 + $CellContext`x - 1, $CellContext`newton[
           Pattern[$CellContext`f, 
            Blank[]], 
           Pattern[$CellContext`x0, 
            Blank[]], 
...
$CellContext`a, $CellContext`b}, PlotRange -> All, AxesLabel -> {
                Style[$CellContext`x, 16], 
                Style[$CellContext`y, 16]}, PlotStyle -> Thickness[0.006], 
              Epilog -> {{Red, 
                 Thickness[0.002], 
...
Cell["\<\
This Demonstration illustrates geometrically Newton's method for \
approximating roots. The available functions illustrate places where Newton's \
method yields interesting behavior.\
\>", "ManipulateCaption"],
...
LearningNewtonsMethod&version=0017"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/LearningNewtonsMethod/\
LearningNewtonsMethod-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Learning Newton's Method",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/LearningNewtonsMethod/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/LearningNewtonsMethod/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/LearningNewtonsMethod/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/LearningNewtonsMethod/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/LearningNewtonsMethod/"]
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Angela Sharp",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Angela+Sharp"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Angela+Sharp"],
 ", ",
 ButtonBox["Chad Pierson",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Chad+Pierson"], 
    None}],
 ", and ",
 ButtonBox["Joshua Fritz",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Joshua+Fritz"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Joshua+Fritz"]
}], "Author",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[42393, 758, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[42654, 767, 691, 15, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[50365, 949, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 77041, 1518},
 {"Copyright", 77235, 1523}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34967, 592, 7201, 158, 70, "Output",
 CellID->197594186],
Cell[42171, 752, 219, 4, 70, "ManipulateCaption"],
Cell[42393, 758, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[42654, 767, 691, 15, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43348, 784, 44, 0, 70, "RelatedLinksSection"],
Cell[43395, 786, 567, 20, 70, "RelatedLinks",
 CellID->71693908],
Cell[43965, 808, 4802, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[48770, 899, 45, 0, 70, "CitationSection"],
Cell[48818, 901, 792, 20, 70, "Citations"],
Cell[49613, 923, 749, 24, 70, "Author"],
Cell[50365, 949, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature qTET2bTKk#E4vu7VnWoBhkqN *)
